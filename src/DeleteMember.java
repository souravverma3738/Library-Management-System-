...
public class DeleteMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("DELETE  YOUR MEMBER DETAILS");
  ...
  int x=Integer.parseInt(jComboBox2.getSelectedItem().toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if(address.equals(""))
        {
            ...
            {
               int memberid=Integer.parseInt(jComboBox2.getSelectedItem().toString());
                try{
                 Class.forName("com.mysql.jdbc.Driver");
                 java.sql.Connection conn;
                 conn = (java.sql.Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/book1?zeroDateTimeBehavior=convertToNull","root","");
                 java.sql.Statement stmt= (java.sql.Statement)conn.createStatement();
                 int excuteUpdate;
                 excuteUpdate= stmt.executeUpdate("delete from member where memberid="+ memberid);
